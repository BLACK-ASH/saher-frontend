...
export function ForgotPasswordForm({
  ...
  const emailFrom = useForm<z.infer<typeof emailSchema>>({
    resolver: zodResolver(emailSchema),
    defaultValues: {
      email: "",
    },
  });
  const onRequestSubmit = async (data: z.infer<typeof emailSchema>) => {
  ...
  return !token ? (
    <Card>
      ...
      <CardContent>
        <form onSubmit={emailFrom.handleSubmit(onRequestSubmit)}>
          <Controller
            name="email"
            control={emailFrom.control}
