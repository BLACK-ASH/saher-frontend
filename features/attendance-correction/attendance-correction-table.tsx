...
const AdminAttendanceCorrectionTable = () => {
  ...
  if (!corrections) return <NoData className="col-span-2" title="No Chart To Show." description="Please Refresh or You Don't Have Any Attendance To Show This Chart." />

  return (
    <div className="container mx-auto col-span-2 row-span-3 h-full">
      <AttendanceCorrectionDataTable columns={attendanceCorrectionColumns} data={corrections} />
    </div>
  )
}
